...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="navbar">
    <a class="navbar-brand" href="#">Nouvelle Tache </a>
...
<center>
    <center>
        <a href="http://localhost:8000/p1/index.php?page=home" class="btn btn-secondary btn-sm" tabindex="-1" role="button"
           aria-disabled="true">Listes des taches</a>
    ...
    <center>
        ...
        <fieldset class="field">
            ...
            <form method="POST" name="formulaire" action="http://localhost:8000/p1/index.php?page=ajout"
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td colspan="2"><p>Date</p>
                                <input class="dt" type="date" name="date" class="form-control">
                        ...
                        <tr>
                            <td><p>Priorité</p>
                                <select name="priot">
                                    <option value="-1">choisir la periorité de votre tache</option>
                        ...
                        <tr>
                            <td>
                                ...
                                <input   class="btn btn-secondary btn-sm" type="submit" value="Ajouter" name="sub" id="btnSubmit">
                            </td>
